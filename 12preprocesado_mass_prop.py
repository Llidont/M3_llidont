...
if(guardarimagenes):
    ...
    display_images(mass_combined, 'image_file_path', 5, 'examples/mass_prop_images.jpeg')
    display_images(mass_combined, 'ROI_mask_file_path', 5, 'examples/mass_prop_roi.jpeg')
