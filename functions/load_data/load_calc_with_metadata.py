...
def load_calc_with_metadata(image_size, batch_size, file_name = "processed_dataset_info.csv"):
...
class ImageDataset(Dataset):
        ...
        def __getitem__(self, idx):
            ...
            shape = torch.tensor(self.dataframe.loc[idx, "calc_type"], dtype=torch.long)
            margins = torch.tensor(self.dataframe.loc[idx, "calc_distribution"], dtype=torch.long)
